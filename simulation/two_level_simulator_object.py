...
class two_level_lifetime_generator():
    ...
    def BO_training_simulator_3_curves(self, emailme = False):
        '''
        This function simulate the lifetime for two-level defects specifically for BO
    ...
    def BO_training_simulator_2_curves(self, emailme = False):
        '''
        This function simulate the lifetime for two-level defects specifically for BO
        ...
        'Et_max_2':0.306,              #   Maximum defect energy level
        'S_min_1_p':1e-15,              #   Minimum capture cross section for hole. # true solution is 1e-15 cm^2
        'S_min_1_n':1.27e-15,          #   Minimum capture cross section for electron. # 1.27e-15 cm^2
        'S_max_1_p':1e-15,              #   Maximum capture cross section for hole.
        'S_max_1_n':1.27e-15,              # maximum capcture cross section for electron.
        ...
        # combine the three lifetime curves horizontally
        available_data = [dataDf_p_303, dataDf_n_303]
        dataDf = pd.concat(available_data,axis=1)
        # remove the duplicated columns
        dataDf = dataDf.loc[:,~dataDf.columns.duplicated()]
        # upload the data
