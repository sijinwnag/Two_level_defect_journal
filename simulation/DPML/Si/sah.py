...
class Sah():
    ...
    def __init__(self,c,d1,d2,dnrange):
        ...
        # run this cell only if we want to fix the Et and Sp1
        # d1.Sn = 1e-14
        # d1.Sp = 1e-15
        # d1.Et = 0.5
        ...
        # sanity check:
        # print('p1 is ' + str(self.p1_1))
        # print('n1 is ' + str(self.n1_1))
        # print('p2 is ' + str(self.p1_2))
        # print('n2 is ' + str(self.n1_2))
        # print('Vn is ' + str(c.Vn))
        # print('Vp is ' + str(c.Vp))
        # print('Sn1 is ' + str(d1.Sn))
        # print('Sn2 is ' + str(d2.Sn))
        # print('Sp1 is ' + str(d1.Sp))
        # print('Sp2 is ' + str(d2.Sp))
        # print('Temperature is ' + str(c.T))
        # print('Nt is ' + str(d1.Nt) + ' ' + str(d2.Nt))
        # print('Et1 is ' + str(d1.Et))
        # print('Et2 is ' + str(d2.Et))
        # print('ni is ' + str(c.ni))

        # lets break down the equation to see what it really is:
        # term1 = (Decimal(c.p0)+Decimal(dn)+Decimal(d1.k*self.n1_1))
        # term2 = (Decimal(self.p1_1)+Decimal(d1.k)*(Decimal(c.n0)+Decimal(dn)))
        # term3 = (Decimal(self.p1_2)+Decimal(d2.k)*(Decimal(c.n0)+Decimal(dn)))
        # term4 = (Decimal(c.p0)+Decimal(dn)+Decimal(d2.k*self.n1_2))
        # term5 = (Decimal(c.n0)+Decimal(c.p0)+Decimal(dn))
        # term6 = 1/(Decimal(self.taun0_1*self.p1_1)+Decimal(self.taup0_1)*(Decimal(c.n0)+Decimal(dn)))
        # term7 = 1/(Decimal(self.taun0_2)*(Decimal(c.p0)+Decimal(dn))+Decimal(self.taup0_2)*Decimal(self.n1_2))
        # self.tauSah = (1 + term1/term2 + term3/term4)/(term5 * (term6 + term7))
