...
for Ndop,T,doptype,r in zip(Doplist,Tlist,Typelist,rlist):
    nxc=np.logspace(12,16,50)
    tau = r*twolevelSRH_full(nxc=nxc,Ndop=Ndop,T=T,doptype=doptype, Nt=Nt, Et1=Et1, Et2=Et2,sigma_e1=se1, sigma_h1=sp1,sigma_e2=se2, sigma_h2=sp2)
    nxclist.append(nxc)
    taulist.append(tau)
